<template lang="pug">
  .extension(:class="classList")
    ...
    .extension__imageWrapper
      img.extension__image(:src="image")
    .extension__info
      .extension__name {{ extension.name }}
      .extension__desc {{ description }}
</template>
...
export default {
  ...
  computed: {
    ...
    description () {
      return this.extension.desc || 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad'
    },
